...
public class ZgDetector {
	static boolean check(String input) {
		String myanmar = "[\u1000-\u109f]";
		String zawgyiRegex = "\u1031\u103b" // e+medial ra
				// beginning e or medial ra
				+ "|^\u1031|^\u103b"
				// independent vowel, dependent vowel, tone , medial ra wa ha
				// (no ya
				...
				// + "|[\u102d\u102e][\u102d\u102e]"
				// U UU + U UU
				// + "|[\u102f\u1030][\u102f\u1030]" [ FIXED!! It is not so
				// valuable zawgyi pattern ]
				// tall aa short aa
				// + "|[\u102b\u102c][\u102b\u102c]" [ FIXED!! It is not so
				// valuable zawgyi pattern ]
				// shan digit + vowel
				+ "|[\u1090-\u1099][\u102b-\u1030\u1032\u1037\u103c-\u103e]"
				...
				// ya + medial wa
				+ "|\u101b\u103c"
				// non digit + zero + \u102d (i vowel) [FIXED!!! rules tested
				// zero + i vowel in numeric usage]
				+ "|[^\u1040-\u1049]\u1040\u102d"
				// e + zero + vowel
				+ "|\u1031?\u1040[\u102b\u105a\u102e-\u1030\u1032\u1036-\u1038]"
				// e + seven + vowel
				...
				+ "|\u1039[\u107E-\u1084]";
		Pattern myanmarPtn = Pattern.compile(myanmar);
		Matcher myanMatcher = myanmarPtn.matcher(input);
		if (!myanMatcher.find()) {
			return false;
		}
		Pattern zgPattern = Pattern.compile(zawgyiRegex);
		Matcher zgMatcher = zgPattern.matcher(input);
